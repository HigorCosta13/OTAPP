            ...
            <View style={cadastroStyle.view}>
                <Card>
                    <Card.Content>
                        ...
                        <Button icon="google" mode="outlined" onPress={() => console.log('Pressed')} style={cadastroStyle.google}>
                            <Text>Sincronizar com o Google</Text>
                        </Button>
                        <View>
                            <Text style={cadastroStyle.text3}>OU</Text>
                        </View>
                        <Button mode="contained" style={cadastroStyle.button} onPress={() => console.log('Pressed')}>
                            <Text style={cadastroStyle.textButton}>Entrar</Text>
                        </Button>
