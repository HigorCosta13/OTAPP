...
export default function app() {
    return (
        <NavigationContainer>
          ...
          >
            <Tab.Screen name="Cadastro" component={cadastro} options={{  tabBarIcon: ({ color }) => ( <MaterialCommunityIcons name="sticker-check" color={color} size={26} /> ),}} />
            <Tab.Screen name="Login" component={login} options={{  tabBarIcon: ({ color }) => ( <MaterialCommunityIcons name="login" color={color} size={26} /> ),}} />
            ...
            <Tab.Screen name="Agendar" component={agendamento}options={{  tabBarIcon: ({ color }) => ( <MaterialCommunityIcons name="alarm" color={color} size={26} /> ),}}  />
